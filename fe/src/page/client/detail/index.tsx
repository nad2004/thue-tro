...
export default function DetailPage() {
  ...
  const [isSaved, setIsSaved] = useState(article?.isLiked || false);
  useEffect(() => {
    if (!article) return;
    setIsSaved(article.isLiked);
  }, [article]);
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <Breadcrumb
          ...
          items={[
            ...
            {
              title: (
                <span className="text-gray-500 truncate max-w-[200px] inline-block align-bottom">
                  {article.title}
                </span>
              ),
            },
                          ...
                          preview={{
                            mask: (
                              <div className="text-white flex items-center gap-2">
                                <Maximize2 size={16} /> Xem phóng to
                              </div>
                            ),
                          }}
                        />
            ...
            <Card bordered={false} className="shadow-sm rounded-xl mb-6">
              ...
              <div className="flex flex-wrap items-center gap-6 md:gap-12 p-4 bg-gray-50 rounded-lg border border-gray-100 mb-6">
                <div>
                  ...
                  <Text className="text-[#e03c31] text-2xl font-bold">
              ...
              <div className="flex gap-3">
                ...
                <Button icon={<Share2 size={16} />} onClick={handleShare} size="large">
                  Chia sẻ
                </Button>
              </div>
            </Card>
            ...
            <div className="sticky top-6 space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
                ...
                <Text className="text-blue-800 text-sm block">
                  Không đặt cọc khi chưa xem nhà. Kiểm tra giấy tờ chính chủ kỹ lưỡng trước khi ký
                  hợp đồng thuê trọ.
                </Text>
              </div>
            </div>
